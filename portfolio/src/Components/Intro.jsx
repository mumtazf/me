...
const Intro = () => {
    ...
    As a rising senior in college, I enjoy tinkering with different technologies. <br/> I realize that there is a breadth of knowledge out there so I keep myself open to learning new things.
